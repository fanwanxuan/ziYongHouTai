...
function addrole(){//添加角色
	if(!jQuery(".editbox").is(":animated")){//没有执行动画的情况下
		...
		if(_jsmc === ""){
			jQuery(".editbox .error-tips").text("请输入角色名称！");
		}
		if(_jsmc !== "" && _error === ""){
			var _row = jQuery('<div class="row"><div class="check"><div class="check-box"><i class="icon-check"></i></div></div><div class="jsmc">'+_jsmc+'</div><div class="cz"><a href="javascript:;" title="权限" class="icon-authority">权限</a><a href="javascript:;" title="编辑" class="icon-edit">编辑</a></div></div>');
